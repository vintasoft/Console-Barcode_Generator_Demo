...
3. Build the project ("BarcodeGeneratorConsoleDemo.Net7.csproj" file) in Visual Studio or using .NET CLI:
   ```
   dotnet build BarcodeGeneratorConsoleDemo.Net7.csproj
   ```
